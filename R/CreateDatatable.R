...
CreateDatatable<-function(t, fn, format=TRUE, rownames=TRUE, caption='', selection='none', ...) {
  ...
  pg<-DT::datatable(t, options=list("pageLength"=50, "serverSide"=object.size(t)>10^5), rownames=FALSE, caption=caption, selection=selection, filter='bottom', escape=FALSE, ...);
